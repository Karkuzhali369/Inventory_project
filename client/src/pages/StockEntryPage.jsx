...
const entries = [
  {
    ...
    profit: 13000,
    enteredBy: "John",
    // Line items for the popup table
    items: [
      { name: "Acer Nitro V", category: "Electronics", qty: 2, price: 65000 },
      { name: "Acer Nitro V", category: "Electronics", qty: 2, price: 65000 },
      { name: "Acer Nitro V", category: "Electronics", qty: 2, price: 65000 },
      { name: "Acer Nitro V", category: "Electronics", qty: 2, price: 65000 },
    ],
  },
  {
    ...
    enteredBy: "Joe",
    items: [
      { name: "Hammer", category: "Hardware", qty: 10, price: 300 },
      { name: "Wire Roll", category: "Electrical", qty: 4, price: 1200 },
    ],
  },
  {
    date: "13/08/2025",
...
const StockEntryPage = () => {
  ...
  // Calculate total sold for popup footer
  const totalSold =
  ...
  return (
    <div className="max-w-3xl mx-auto p-6 bg-white rounded-2xl shadow-lg mt-8">
      ...
      {/* BLUE overlay modal with the exact table layout */}
      {selectedEntry && (
        <div
              ...
              <div className="overflow-x-auto rounded-lg border border-gray-200">
                <table className="w-full text-sm">
                  ...
                  <tbody className="divide-y divide-dashed divide-gray-300">
                    {(selectedEntry.items && selectedEntry.items.length > 0 ? selectedEntry.items : [
                      // fallback demo if entry has no items
                      { name: "—", category: "—", qty: 0, price: 0 },
                    ]).map((it, i) => {
